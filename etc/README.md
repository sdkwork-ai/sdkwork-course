# sdkwork-course Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-course` |
| `runtimeCode` | `course` |
| Config root | `/etc/sdkwork/course/` |
| Runtime TOML | `/etc/sdkwork/course/config.toml` |
| Secrets | `/etc/sdkwork/course/secrets/` |
| Override | `SDKWORK_COURSE_CONFIG_FILE` |
