...
Module `sdkwork-course` · runtime code `course` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `course-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `course-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `course-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 14 | `course-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `course.sdkwork.com` | 443 ssl + 80 |
