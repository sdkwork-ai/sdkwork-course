...
`sdkwork.app.config.json` is present at this repository root and governs runtime API prefixes, SDK families, and deployment profile defaults for the course application.
