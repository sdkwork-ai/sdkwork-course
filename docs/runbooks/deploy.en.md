# Runbook — sdkwork-course deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-course-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-course/bundle`, loads the image, starts
